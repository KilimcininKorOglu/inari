#!/usr/bin/env python3
"""Cross-reference git diff against inari refs --json ground truth.
...
The ground truth file should be the JSON output of `inari refs <symbol> --json`,
...
def main() -> int:
    ...
    parser.add_argument(
        "--ground-truth",
        required=True,
        help="Path to the ground truth JSON file (output of inari refs --json)",
    )
    parser.add_argument(
        "--output",
        required=False,
